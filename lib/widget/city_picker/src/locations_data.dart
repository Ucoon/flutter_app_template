...
class Address {
  ...
  // 是否在市、区级添加 全部选项
  static bool addAllItem = false;

  static List<Map<String, String>> getCities(String province) {
  ...
  static List<Map<String, String>> getTowns(cityCode) {
    var emptyData = {'name': "全部", 'townCode': ''};
    if (PicketUtil.strEmpty(cityCode)) return [emptyData];
    ...
    if (PicketUtil.mapEmpty(areaList)) {
      ...
      if (areaList != null && addAllItem) data.add(emptyData);
      areaList?.forEach((key, value) {
        data.add({'name': value, 'townCode': key});
      });
      return data;
    }
  }
